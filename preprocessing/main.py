...
from preprocessing import preprocess_clean, preprocess_pre, pre_cooccurrence, preprocess_rlabel
...
if __name__ == "__main__":
    ...
    # data
    parser.add_argument("--data_dir", type=str, default="/cluster/scratch/yifhou/wikidata/all_clean",
