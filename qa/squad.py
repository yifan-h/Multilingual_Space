...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training, lang2id):
    ...
    while len(spans) * doc_stride < len(all_doc_tokens):
        ...
        # print(max_seq_length, max_seq_length - doc_stride - len(truncated_query) - sequence_pair_added_tokens)
        ...
        # print(paragraph_len, tokenizer.pad_token_id, encoded_dict["input_ids"].index(tokenizer.pad_token_id))
        ...
        if "overflowing_tokens" not in encoded_dict:
            break
        if len(encoded_dict["overflowing_tokens"]) == 0: break
...
def squad_convert_examples_to_features(
    ...
    features = [squad_convert_example_to_features(
                     ...
                     max_query_length=max_query_length,
                     is_training=is_training,
                     lang2id=lang2id) for example in examples]
